...
public class DownloaderTaskFragment extends Fragment {
    ...
    private DownloadFinishedListener mCallbackPermanent;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Integer> rawTextFeedIds = null;
        Bundle bundle = this.getArguments();
        if (bundle != null) {
            rawTextFeedIds = bundle.getIntegerArrayList(TAG_FRIEND_RES_IDS);
        }


        // TODO: Start the DownloaderTask
        System.out.println("Start the DownloaderTask.");
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            ...
            mCallbackPermanent = (DownloadFinishedListener) activity;
            System.out.println("mCallback assigned.");
    ...
    public void onDetach() {
        super.onDetach();
        System.out.println("Null out mCallback.");
		mCallback = null;
    }
    ...
    public class DownloaderTask extends AsyncTask<ArrayList<Integer>, Void, String[]> {
        ...
        protected String[] doInBackground(ArrayList<Integer>... arrayLists) {
            ...
            resourceIDs = arrayLists[0].toArray(resourceIDs);
            String[] tweets = downloadTweets(resourceIDs);
        ...
        mContext.sendOrderedBroadcast(new Intent(
                ...
                new BroadcastReceiver() {
                    ...
                    public void onReceive(Context context, Intent intent) {
                        ...
                        boolean broadcastReceived = getResultCode() == MainActivity.IS_ALIVE;
